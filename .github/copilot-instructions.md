...
```
src/
├── PSMemeGenerator.psd1      # Module manifest (auto-updated)
...
Import-Module ./build/out/PSMemeGenerator/PSMemeGenerator.psd1 -Force
...
- **Build script**: `PSMemeGenerator.build.ps1`
- **Module manifest**: `src/PSMemeGenerator.psd1`
